...
namespace legion112\dynamicform;
...
class DynamicFormWidget extends Widget
{
    ...
    /**
     * @var \yii\base\Model|\yii\db\ActiveRecord the model used for the form
     */
    public $model;
    /**
     * @var string form ID
    ...
    /**
     * @var string the regular expression for id
     */
    public $regexID = '^(.+?)([-\d-]{1,})(.+)$';

    /**
     * @var string he regular expression for name
     */
    public $regexName = '(^.+?)([\[\d{1,}\]]{1,})(\[.+\]$)';
    /**
     * @var string
     */
    private $_options;
    ...
    protected function initOptions()
    {
        ...
        $this->_options['regexID'] = $this->regexID;
        $this->_options['regexName'] = $this->regexName;
